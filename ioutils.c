 ...
 */
int stdout_redirect_if_requested(const struct opt_parsed *parsed_options) {
    ...
    if (opt_is_present(parsed_options, 'o')) {
        ...
        // Apri il nuovo file in scrittura
        ...
        // Duplica sul file descriptor dello stdout, chiudendolo
